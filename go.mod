...
require (
	...
	sigs.k8s.io/kubebuilder-declarative-pattern v0.20.0-beta.1.0.20260428182003-3b10c1183711
...
replace (
	...
	sigs.k8s.io/kubebuilder-declarative-pattern => ./third_party/sigs.k8s.io/kubebuilder-declarative-pattern
)
